...
yes_know_maybe = ["Ace", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Jack", "Queen", "King"]
        ...
        if socks == server:    #Things that server wants to tell us 
            ...
            if message == "msg\n":   # messages all other players
                ...
                if IWANTIT not in yes_know_maybe:
                    print("You have entered an invalid card value. Here are some examples: Jack, Queen, King, Ace, Ten, Three.")
                else:
                    ...
                    if(LEMMEGRABIT not in theotherplayers or LEMMEGRABIT == name):
                        print("There are no players with this name. Here are the names of the other players playing with you:")
